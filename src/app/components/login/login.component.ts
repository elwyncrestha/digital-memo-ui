...
import { UserService, UserStates } from 'src/app/@core/services';
...
export class LoginComponent implements OnInit {
  ...
  submit(): void {
    ...
    const headers = new HttpHeaders({
      ...
      Authorization: 'Basic ZGlnaXRhbF9tZW1vOm1lbW8jZGlnaXRhbA==',
    });
    this.http.post(securityUrl, body, { headers }).subscribe(
      (data: any) => {
